...
const marsTextureFiles = {
    'TER': '/models/cropAsset 2-100.jpg',//5672_mars_4k_color.jpg',
    'GRE': '/models/marsgreen.jpeg',
    'ELE': '/models/c2880x2160.jpeg',
};
window.currentTexture = 'TER';

export default function marsglobe(canvas,scene,renderer){
    ...
    marsglobe_control(mars,textureLoader);
};

function marsglobe_control(mars,textureLoader){
    /**
     * Keyboard Controls
     */
